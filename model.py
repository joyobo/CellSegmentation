...
class EfficientNet_Attention_UNet(nn.Module):
    def __init__(self, model):
        ...
        self.conv_size0 = convrelu(16, 64, 3, 1)
        self.conv_size1 = convrelu(24, 64, 3, 1)
        self.conv_size2 = convrelu(40, 128, 3, 1)
        self.conv_size3 = convrelu(112, 256, 3, 1)
        self.conv_size4 = convrelu(320, 512, 3, 1)
    ...
    def forward(self, input):
        ...
        layer0 = endpoints['reduction_1'] # torch.Size([1, 16, 112, 112])
        layer0 = self.conv_size0(layer0)
        layer1 = endpoints['reduction_2'] # torch.Size([1, 24, 56, 56])
        layer1 = self.conv_size1(layer1)
        layer2 = endpoints['reduction_3'] # torch.Size([1, 40, 28, 28])
        layer2 = self.conv_size2(layer2)
        layer3 = endpoints['reduction_4'] # torch.Size([1, 112, 14, 14])
        layer3 = self.conv_size3(layer3)
        layer4 = endpoints['reduction_5'] # torch.Size([1, 1280, 7, 7])
